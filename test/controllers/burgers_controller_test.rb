...
class BurgersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create burger" do
    assert_difference('Burger.count') do
      post burgers_url, params: { burger: { devoured: @burger.devoured, name: @burger.name } }
    end
  ...
  test "should update burger" do
    patch burger_url(@burger), params: { burger: { devoured: @burger.devoured, name: @burger.name } }
